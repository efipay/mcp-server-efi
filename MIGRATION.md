...
1. Atualize o host para Node.js 22 ou use a imagem `ghcr.io/efipay/mcp-server-efi-bank:1.0.0`.
...
7. Para Smithery, substitua o antigo `smithery.yaml` pelo bundle produzido com `npm run mcpb:pack`.
